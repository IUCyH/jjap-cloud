...
public class PlaylistService {
    ...
    @Transactional
    public void addMusicToPlaylist(Long userId, String playlistPublicId, Music music) {
    ...
    @Transactional
    public void removeMusicFromPlaylist(Long userId, String playlistPublicId, Music music) {
